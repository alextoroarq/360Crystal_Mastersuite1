...
// Filename: Skin Pueba 2.ggsk
// Generated 2022-03-12T08:10:14
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		el=me._plano_suite_3=document.createElement('div');
		el.ggFilter = '';
		el.ggFilteredIds = [];
		el.ggMapNotLoaded = true;
		el.ggId="Plano Suite 3";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='100% 0%';
		me._plano_suite_3.ggIsActive=function() {
		...
		me._plano_suite_3.ggUpdateConditionResize=function () {
			var mapDetails = player.getMapDetails(me._plano_suite_3.ggMapId);
			if (!(mapDetails.hasOwnProperty('title'))) return;
			me._plano_suite_3.ggCalculateFloorplanSize(mapDetails);
			me._plano_suite_3.ggShowSimpleFloorplan(mapDetails);
			me._plano_suite_3.ggPlaceMarkersOnSimpleFloorplan();
			me._plano_suite_3.ggRadar.update();
		}
		me._plano_suite_3.ggUpdateConditionTimer=function () {
			me._plano_suite_3.ggRadar.update();
		}
		me._plano_suite_3.ggUpdatePosition=function (useTransition) {
			me._plano_suite_3.ggUpdateConditionResize();
		}
		me._plano_suite_3.ggNodeChange=function () {
			var mapDetails = player.getMapDetails(me._plano_suite_3.ggMapId);
			if (!(mapDetails.hasOwnProperty('title'))) return;
			me._plano_suite_3.ggCalculateFloorplanSize(mapDetails);
			me._plano_suite_3.ggShowSimpleFloorplan(mapDetails);
			me._plano_suite_3.ggPlaceMarkersOnSimpleFloorplan();
			me._plano_suite_3.ggRadar.update();
			if (me._plano_suite_3.ggLastNodeId) {
				var lastActiveMarker = me._plano_suite_3.ggSimpleFloorplanMarkerArray[me._plano_suite_3.ggLastNodeId];
				if (lastActiveMarker && lastActiveMarker.ggDeactivate) lastActiveMarker.ggDeactivate();
			}
			var id = player.getCurrentNode();
			var marker = me._plano_suite_3.ggSimpleFloorplanMarkerArray[id];
			if (marker) {
				if (marker.ggActivate) marker.ggActivate();
			}
			me._plano_suite_3.ggLastNodeId = id;
		}
		me._carpeta_plano.appendChild(me._plano_suite_3);
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			''+
			''+
			''+
			''+
			''+
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			...
			''+
			''+
			''+
			''+
			''+
			''+
			'M0MS0zMzIzLjExMS0yNTUyLjIxOHoiIHN0cm9rZS13aWR0aD0iMC4yIiBzdHJva2U9IiMxQTE3MUIiLz4KICAgPC9nPgogIDwvZz4KIDwvZz4KIDxnIGlkPSJMYXllcl8yIi8+Cjwvc3ZnPgo=';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			''+
			''+
			'';
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			''+
			''+
			'';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			...
			''+
			''+
			'';
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			...
			''+
			''+
			''+
		...
		me._plano_suite_3.ggMarkerInstances=[];
		me._plano_suite_3.ggMapId = 'PlanoSuite3';
		me._plano_suite_3.ggLastNodeId=null;
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_changenode = function(){
			if(me._plano_suite_3.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._plano_suite_3.ggMarkerInstances.length; i++) {
					if (me._plano_suite_3.ggMarkerInstances[i]._map_pin_tt && me._plano_suite_3.ggMarkerInstances[i]._map_pin_tt.logicBlock_alpha) {
						me._plano_suite_3.ggMarkerInstances[i]._map_pin_tt.logicBlock_alpha();
					}
				}
			}
		}
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_configloaded = function(){
			if(me._plano_suite_3.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._plano_suite_3.ggMarkerInstances.length; i++) {
					if (me._plano_suite_3.ggMarkerInstances[i]._map_pin_tt && me._plano_suite_3.ggMarkerInstances[i]._map_pin_tt.logicBlock_position) {
						me._plano_suite_3.ggMarkerInstances[i]._map_pin_tt.logicBlock_position();
					}
				}
			}
		}
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_mouseover = function(){
			if(me._plano_suite_3.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._plano_suite_3.ggMarkerInstances.length; i++) {
					if (me._plano_suite_3.ggMarkerInstances[i]._map_pin_active && me._plano_suite_3.ggMarkerInstances[i]._map_pin_active.logicBlock_scaling) {
						me._plano_suite_3.ggMarkerInstances[i]._map_pin_active.logicBlock_scaling();
					}
					if (me._plano_suite_3.ggMarkerInstances[i]._map_pin_normal && me._plano_suite_3.ggMarkerInstances[i]._map_pin_normal.logicBlock_scaling) {
						me._plano_suite_3.ggMarkerInstances[i]._map_pin_normal.logicBlock_scaling();
					}
				}
			}
		}
		...
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_active = function(){
			if(me._plano_suite_3.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._plano_suite_3.ggMarkerInstances.length; i++) {
					if (me._plano_suite_3.ggMarkerInstances[i]._map_pin_active && me._plano_suite_3.ggMarkerInstances[i]._map_pin_active.logicBlock_alpha) {
						me._plano_suite_3.ggMarkerInstances[i]._map_pin_active.logicBlock_alpha();
					}
					if (me._plano_suite_3.ggMarkerInstances[i]._map_pin_normal && me._plano_suite_3.ggMarkerInstances[i]._map_pin_normal.logicBlock_alpha) {
						me._plano_suite_3.ggMarkerInstances[i]._map_pin_normal.logicBlock_alpha();
					}
				}
			}
		}
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_hastouch = function(){
			if(me._plano_suite_3.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._plano_suite_3.ggMarkerInstances.length; i++) {
					if (me._plano_suite_3.ggMarkerInstances[i]._map_pin_tt && me._plano_suite_3.ggMarkerInstances[i]._map_pin_tt.logicBlock_position) {
		...
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_activehotspotchanged = function(){
			if(me._plano_suite_3.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._plano_suite_3.ggMarkerInstances.length; i++) {
					if (me._plano_suite_3.ggMarkerInstances[i]._map_pin_tt && me._plano_suite_3.ggMarkerInstances[i]._map_pin_tt.logicBlock_alpha) {
		...
		me._plano_suite_3.ggSimpleFloorplanMarkerArray=[];
		me._plano_suite_3.ggFloorplanWidth=0;
		me._plano_suite_3.ggFloorplanHeight=0;
		me._plano_suite_3__mapdiv=document.createElement('div');
		me._plano_suite_3__mapdiv.className='ggskin ggskin_map';
		me._plano_suite_3.appendChild(me._plano_suite_3__mapdiv);
		me._plano_suite_3__img=document.createElement('img');
		me._plano_suite_3__img.className='ggskin ggskin_map';
		me._plano_suite_3__mapdiv.appendChild(me._plano_suite_3__img);
		me._plano_suite_3.ggRadar={ lastFov : -1, lastPan : -1, xPos : -1, yPos : -1, radarElement : null }
		me._plano_suite_3.ggRadar.update=function() {
			var radar=me._plano_suite_3.ggRadar;
			var d2r = Math.PI/180 ;
			var fov = player.getFov();
			var pan = player.getPanNorth();
			pan -= me._plano_suite_3.ggFloorplanNorth;
			var filterpassed = true;
			var currentId = player.getCurrentNode();
			if (me._plano_suite_3.ggFilteredIds.length > 0 && me._plano_suite_3.ggFilteredIds.indexOf(currentId) == -1) filterpassed = false;
			if ((me._plano_suite_3.ggSimpleFloorplanMarkerArray.hasOwnProperty(currentId)) && filterpassed) {
				var activeMarker = me._plano_suite_3.ggSimpleFloorplanMarkerArray[currentId];
				if ((radar.radarElement) && (fov==radar.lastFov) && (pan==radar.lastPan) && (activeMarker.radarXPos==radar.xPos) && (activeMarker.radarYPos==radar.yPos)) return; 
				radar.lastPan=pan; radar.lastFov=fov;
				radar.xPos=activeMarker.radarXPos; radar.yPos=activeMarker.radarYPos;
				if (radar.radarElement) me._plano_suite_3__mapdiv.removeChild(radar.radarElement);
				...
				me._plano_suite_3__mapdiv.appendChild(radar.radarElement);
				var radarXPos = activeMarker.radarXPos - 50;
				var radarYPos = activeMarker.radarYPos - 50;
				radar.radarElement.style['position'] = 'absolute';
				radar.radarElement.style['left'] = '' + radarXPos + 'px';
				radar.radarElement.style['top'] = '' + radarYPos + 'px';
				radar.radarElement.style['z-index'] = me._plano_suite_3.style['z-index'] + 1;
			} else {
				if (radar.radarElement) {
					me._plano_suite_3__mapdiv.removeChild(radar.radarElement);
					radar.radarElement = null;
				}
			}
		}
		me._plano_suite_3.ggShowSimpleFloorplan=function(mapDetails) {
			var mapWidth = me._plano_suite_3.clientWidth;
			var mapHeight = me._plano_suite_3.clientHeight;
			...
			var imageFilename = basePath + 'images/maptiles/' + me._plano_suite_3.ggMapId + '_' + level + '.' + mapDetails['tileformat'];
			me._plano_suite_3__img.setAttribute('src', imageFilename);
		me._plano_suite_3__mapdiv.setAttribute('style','position: absolute; right: 0px; top: 0px;width:' + me._plano_suite_3.ggFloorplanWidth + 'px;height:' + me._plano_suite_3.ggFloorplanHeight + 'px;overflow:hidden;;');
		me._plano_suite_3__img.setAttribute('style','width:' + me._plano_suite_3.ggFloorplanWidth + 'px;height:' + me._plano_suite_3.ggFloorplanHeight + 'px;-webkit-user-drag:none;pointer-events:none;');
		}
		me._plano_suite_3.ggCalculateFloorplanSize=function(mapDetails) {
			var floorplanWidth = mapDetails['width'];
			var floorplanHeight = mapDetails['height'];
			var frameAR = me._plano_suite_3.clientWidth / me._plano_suite_3.clientHeight;
			var floorplanAR = floorplanWidth / floorplanHeight;
			if (frameAR > floorplanAR) {
				me._plano_suite_3.ggFloorplanHeight = me._plano_suite_3.clientHeight;
				me._plano_suite_3.ggFloorplanWidth = me._plano_suite_3.ggFloorplanHeight * floorplanAR;
			} else {
				me._plano_suite_3.ggFloorplanWidth = me._plano_suite_3.clientWidth;
				me._plano_suite_3.ggFloorplanHeight = me._plano_suite_3.ggFloorplanWidth / floorplanAR;
			}
		}
		me._plano_suite_3.ggInitMap=function() {
			me._plano_suite_3.ggMapNotLoaded = false;
			var mapDetails = player.getMapDetails(me._plano_suite_3.ggMapId);
			me._plano_suite_3.style.backgroundColor = mapDetails['bgcolor'];
			if (mapDetails.hasOwnProperty('transparent') && mapDetails['transparent']) {
				me._plano_suite_3.ggPermeableMap = true;
			} else {
				me._plano_suite_3.ggPermeableMap = false;
			}
			me._plano_suite_3.ggCalculateFloorplanSize(mapDetails);
			me._plano_suite_3.ggShowSimpleFloorplan(mapDetails);
			me._plano_suite_3.ggFloorplanNorth = mapDetails['floorplannorth'];
		}
		me._plano_suite_3.ggClearMap=function() {
			me._plano_suite_3.ggClearMapMarkers();
			me._plano_suite_3.ggMapNotLoaded = true;
		}
		me._plano_suite_3.ggChangeMap=function(mapId) {
			var newMapType = player.getMapType(mapId)
			if (newMapType == 'web') {
				return;
			}
			me._plano_suite_3.ggMapId = mapId;
			if (!me._plano_suite_3.ggMapNotLoaded) {
				me._plano_suite_3.ggClearMap();
				me._plano_suite_3.ggInitMap();
				me._plano_suite_3.ggInitMapMarkers();
			}
		}
		me._plano_suite_3.ggPlaceMarkersOnSimpleFloorplan=function() {
			var markers=me._plano_suite_3.ggSimpleFloorplanMarkerArray;
			for (id in markers) {
				if (markers.hasOwnProperty(id)) {
					marker=markers[id];
					var coords = player.getNodeMapCoordsInPercent(id, me._plano_suite_3.ggMapId);
					var xPos = (me._plano_suite_3.ggFloorplanWidth * coords[0]) / 100.0;
					var yPos = (me._plano_suite_3.ggFloorplanHeight * coords[1]) / 100.0;
					marker.radarXPos = xPos;
					marker.radarYPos = yPos;
					xPos -= me._plano_suite_3.ggHMarkerAnchorOffset;
					yPos -= me._plano_suite_3.ggVMarkerAnchorOffset;
					marker.style['position'] = 'absolute';
					marker.style['left'] = xPos + 'px';
					marker.style['top'] = yPos + 'px';
					marker.style['z-index'] = me._plano_suite_3.style['z-index'] + 2;
				}
			}
		}
		me._plano_suite_3.ggInitMapMarkers=function() {
			me._plano_suite_3.ggClearMapMarkers();
			var ids=player.getNodeIds();
			me._plano_suite_3.ggFilteredIds = [];
			if (me._plano_suite_3.ggFilter != '') {
				var filter = me._plano_suite_3.ggFilter.split(',');
				for (i=0; i < ids.length; i++) {
					var nodeId = ids[i];
					var nodeData = player.getNodeUserdata(nodeId);
					for (var j=0; j < filter.length; j++) {
						if (nodeData['tags'].indexOf(filter[j].trim()) != -1) me._plano_suite_3.ggFilteredIds.push(nodeId);
					}
				}
				if (me._plano_suite_3.ggFilteredIds.length > 0) ids = me._plano_suite_3.ggFilteredIds;
			}
			for(var i=0; i < ids.length; i++) {
				var id = ids[i];
				var coords = player.getNodeMapCoordsInPercent(id, me._plano_suite_3.ggMapId);
				if (coords.length>=2) {
					me._plano_suite_3.ggHMarkerAnchorOffset = 12;
					me._plano_suite_3.ggVMarkerAnchorOffset = 41;
					var markerParent = new Object();
					markerParent.ggElementNodeId=function() { return id };
					var markerClass = new SkinElement_map_pin_Class(me, markerParent);
					me._plano_suite_3.ggMarkerInstances.push(markerClass);
					var marker = markerClass._map_pin;
					me._plano_suite_3.ggSimpleFloorplanMarkerArray[id] = marker;
					me._plano_suite_3__mapdiv.appendChild(marker);
				}
			}
			me._plano_suite_3.ggPlaceMarkersOnSimpleFloorplan();
			skin.updateSize(me._plano_suite_3);
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_changenode();
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_configloaded();
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_mouseover();
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_mouseover();
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_active();
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_hastouch();
		me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_activehotspotchanged();
		}
		me._plano_suite_3.ggClearMapMarkers=function() {
			for (id in me._plano_suite_3.ggSimpleFloorplanMarkerArray) {
				if (me._plano_suite_3.ggSimpleFloorplanMarkerArray.hasOwnProperty(id)) {
					me._plano_suite_3__mapdiv.removeChild(me._plano_suite_3.ggSimpleFloorplanMarkerArray[id]);
				}
			}
			me._plano_suite_3.ggMarkerInstances=[];
			me._plano_suite_3.ggSimpleFloorplanMarkerArray=[];
		...
		player.addListener('configloaded', function() {
			me._plano_suite_3.ggClearMap();
			me._plano_suite_3.ggInitMap(false);
			me._plano_suite_3.ggInitMapMarkers(true);
			me._thumbnail_cloner.ggUpdate();
		});
	...
	me.skinTimerEvent=function() {
		...
		me._plano_suite_3.ggUpdateConditionTimer();
		var hs='';
	...
	function SkinCloner_thumbnail_cloner_Class(nodeId, parentScope,ggParent,parameter) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			''+
			''+
			''+
			...
			''+
			...
			''+
			'NmgxNC43MThjMC42NjEsMCwxLjE5Ny0wLjUzNiwxLjE5Ny0xLjE5NnYtMTAuNDAzbC0yLjM5MywyLjM5M1YtMjU4My44Mzd6IiBzdHJva2Utd2lkdGg9IjAuMiIgc3Ryb2tlPSIjMUExNzFCIi8+CiAgIDwvZz4KICA8L2c+CiA8L2c+Cjwvc3ZnPgo=';
	...
	player.addListener('changenode', function(args) { me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_changenode(); });
	player.addListener('configloaded', function(args) { me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_configloaded(); });
	player.addListener('mouseover', function(args) { me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_mouseover(); });
	player.addListener('mouseover', function(args) { me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_mouseover(); });
	player.addListener('changenode', function(args) { me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_active(); });
	player.addListener('hastouch', function(args) { me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_hastouch(); });
	player.addListener('activehotspotchanged', function(args) { me._plano_suite_3.callChildLogicBlocksHotspot_map_pin_activehotspotchanged(); });
